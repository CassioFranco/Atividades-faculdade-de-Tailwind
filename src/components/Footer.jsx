...
const Footer = () => {
  return (
    <footer className="flex flex-col items-center bg-zinc-700 text-center text-surface bg-neutral-700 text-white transition duration-150 ease-in-out hover:bg-green-300">
